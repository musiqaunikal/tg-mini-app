...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/TezPulcha_bot?start=r${id}\n\$SOM tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! $SOM Power Tap! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine $SOM tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/TezPulcha_bot?start=r${id}\n\ `, // Replace with your link
      text: "$SOM tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! $SOM Power Tap! 🚀",
    };
          ...
          <div className="w-full pt-3 justify-center flex-col space-y-3 px-5">
            <div className="w-full flex justify-center">
              <h1 className="font-semibold text-[28px] text-[#ffffffe0] pb-1 text-center">
                Invite friends <br/>& get more $SOM
              </h1>
            </div>
