...
<img src='/dogs.webp' alt='sdfd' className='w-[15px]'/>
          ...
          <span className="text-accent">+{selectedPower.capacity} $SOM</span>
              </span>
          <span>Your Purchase of {selectedPower.xx} $SOM is successful</span>
        </span>
        <p className="pb-6 text-[15px] w-full text-center">
          Perform more activities or buy more $SOM to stay ahead and claim listing giveaway bonues!😎
        </p>
      </div>
      );
...
<img src='/dogs.webp' alt='sdfd' className='w-[70px]'/>
                    ...
                    <p className="pb-6 text-primary text-[14px] px-4 text-center">
                      Get {selectedPower.capacity} $SOM and boost your earnings and ranks!
                    </p>
